...
wget -O --show-progress /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/khairunisya/multiws/main/ssh/newudpgw"
...
echo "<pre>Setup By Jrt Team Grups</pre>" >/home/vps/public_html/index.html
